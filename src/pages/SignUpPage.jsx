            ...
            <form onSubmit={handelSubmit} className="cardContent flex flex-col space-y-2 items-center">
              {newUser && (
                <input
                  ...
                  className="w-56 lg:w-72 rounded-lg py-2 px-5 shadow-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none text-sm lg:text-lg text-gray-400"
                  placeholder="Name"
                  type="text"
                  name="name"
                  id="name"
              ...
              <input
                onChange={handelInput}
                className="w-56 lg:w-72 lg:h-12 rounded-lg py-2 px-5 shadow-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 focus:outline-none text-sm lg:text-lg text-gray-400"
                placeholder="Email"
                type="email"
                name="email"
                id="email"
              ...
              <input
                className="w-56 lg:w-72 bg-purple-500 text-white rounded-lg py-2 px-5 shadow-lg mt-5 text-md lg:text-lg font-semibold cursor-pointer hover:bg-purple-400"
                type="submit"
